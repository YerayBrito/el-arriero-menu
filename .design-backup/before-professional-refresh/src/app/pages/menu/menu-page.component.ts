    ...
    <div class="page-shell menu-page">
      <header class="page-hero">
        <div class="page-hero-copy">
          ...
          <p class="page-lead">{{ 'menu.lead' | t }}</p>
        </div>
      ...
      <div class="controls surface-panel">
        <input
          class="search"
          type="search"
      ...
      <div class="sections">
        <section class="section" *ngFor="let s of filteredSections()" [class.section-dual-pricing]="s.halfRacionOnly">
          <div class="section-head" [class.section-head-triple]="s.hasTriplePricing">
            ...
            <div class="pricing" *ngIf="s.hasTriplePricing">
              <span *ngIf="!s.halfRacionOnly">{{ 'menu.pricing.tapa' | t }}</span>
            ...
            <article class="item" *ngFor="let it of s.items; let i = index" [class.highlight]="it.highlight">
              <div class="row" [class.row-triple]="s.hasTriplePricing">
                ...
                <div class="prices" *ngIf="s.hasTriplePricing && it.triplePrice">
                  <span *ngIf="!s.halfRacionOnly && it.triplePrice.tapa">{{ it.triplePrice.tapa }}</span>
